...
const SectionTitle = ({title}: PropType) => {
  return (
    <div className="flex flex-col justify-start items-center gap-2 mb-4 md:mb-10 z-10">   
        <h2 className="capitalize px-6 text-center text-xl md:text-3xl font-bold text-transparent bg-gradient-to-r from-sky-500 to-sky-900 bg-clip-text">{title}</h2>
