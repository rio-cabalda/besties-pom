    ...
    <div className="flex w-full items-center justify-center self-stretch">
        {/* Front  */}
            ...
            {/*  */}
                ...
                {/* Front */}
                    <div className="h-full flex flex-col items-end rounded-md shadow-xl bg-slate-100  overflow-hidden">
                        {/* Image and Gradient */}
                        ...
                        <div className={`w-full flex-grow py-10 pt-16 clip-polygon flex justify-center items-center ${spanStyle} lg:hidden`} >
                    ...
                    {/* back */}
                    <div className={`absolute inset-0 h-full ${spanStyle} bg-slate-700 px-12 text-center text-slate-200 [transform:rotateY(180deg)]  [backface-visibility:hidden] rounded-md shadow-xl overflow-hidden`}>
